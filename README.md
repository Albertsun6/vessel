...
- [vessel-aisep](https://github.com/Albertsun6/vessel-aisep) — AISEP (AI Software Engineering Platform) was split out of this repo on 2026-05-15 (see [ADR-024](docs/adr/vessel/ADR-024-aisep-external-repo-during-vessel-development.md)). Long-term goal: rejoin VesselCore as a Capability App once vessel is reasonably complete.
